"""End-to-end pipeline: real training capture → simulation → report.

Loads configs and computational graph captured from real Qwen3 0.6B training,
runs performance simulation, and generates a comparison report.
"""
...
def run_pipeline():
    print("=" * 60)
    print("ModelPerf End-to-End Pipeline")
    print("=" * 60)
